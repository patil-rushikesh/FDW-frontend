    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="mt-2 text-sm text-gray-600">
          ...
          <p>
            Marks = Minimum of (50, 50 * (Average of Total Weekly Load per Semester + E) / Minimum Load as per Cadre)
          </p>
          ...
          <p>
            E = 2 for taking admin responsibility (Deputy/Director/Dean/HoD/Asso. Dean) or monitoring Ph.D. Scholars,
      ...
      <div>
        ...
        <div className="mt-2">
          ...
          {(() => {
            const feedbackPercentage = Number(formData.teaching?.feedbackPercentage || 0);
      ...
      <div>
        ...
        <div className="mt-2 text-sm text-gray-600">
          ...
          <p>
            Proper conduction of PTG meetings in a semester (Minimum 6 meetings in a year).
            (For Student Counseling efforts, marks will be taken as 50 in case of Deputy Director/Deans/HoDs/PG Coordinators/Ph. D. Coordinators).
          </p>
          <p>
            Marks = (Total number of PTG meetings * 50) / 6
          </p>
        </div>
        <div className="mt-2">
      ...
      <div className="mt-4">
        <h3 className="text-lg font-medium text-gray-900">
          ...
          {(() => {
            ...
            const resultScore =
              totalStudents > 0
                ? (studentsAbove60 * 5 + students50to59 * 4 + students40to49 * 3) / totalStudents
                : 0;
            ...
            const elearningScore = Number(formData.teaching?.elearningInstances || 0) * 10;
  
            const studentsPresent = Number(formData.teaching?.studentsPresent || 0);
            const totalEnrolled = Number(formData.teaching?.totalEnrolledStudentsForLectures || 0);
              ...
              <thead>
                <tr>
                  <th className="border border-gray-300 p-2" colSpan="5">
                    <strong>Part A: Academic Involvement: Obtained Marks Summary</strong>
                  </th>
                </tr>
                <tr>
              ...
              <tbody>
                <tr>
                  <td className="border border-gray-300 p-2" colSpan="2">
                    <strong>Cadre wise maximum considerable marks of Academic Involvement</strong>
                  </td>
                ...
                <tr>
                  <td className="border border-gray-300 p-2" colSpan="2">
                    <strong>Obtained marks Calculated from Academic Involvement (as per Table 'A')</strong>
                  </td>
                  <td className="border border-gray-300 p-2">
                    {formData.teaching?.cadre === "Professor" ? totalMarks.toFixed(2) : ""}
                  </td>
                  <td className="border border-gray-300 p-2">
                    {formData.teaching?.cadre === "Associate Professor" ? totalMarks.toFixed(2) : ""}
                  </td>
                  <td className="border border-gray-300 p-2">
                    {formData.teaching?.cadre === "Assistant Professor" ? totalMarks.toFixed(2) : ""}
                  </td>
                </tr>
                <tr>
                  <td className="border border-gray-300 p-2" colSpan="2">
                    <strong>Actual Academic involvement Marks in Self Appraisal</strong>
                  </td>
                  <td className="border border-gray-300 p-2">
                    {formData.teaching?.cadre === "Professor" ? (totalMarks * 0.68).toFixed(2) : ""}
                  </td>
                  <td className="border border-gray-300 p-2">
                    {formData.teaching?.cadre === "Associate Professor" ? (totalMarks * 0.818).toFixed(2) : ""}
                  </td>
                  <td className="border border-gray-300 p-2">
                    {formData.teaching?.cadre === "Assistant Professor" ? totalMarks.toFixed(2) : ""}
                  </td>
