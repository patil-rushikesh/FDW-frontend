            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="text-gray-800">{facultyData.researchAreas}</p>
                )}
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                {isEditing ? (
                  ...
                  <p className="text-gray-800">{facultyData.publications}</p>
                )}
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                {isEditing ? (
                  <input
                    type="number"
                    name="teachingHours"
                    value={facultyData.teachingHours}
                    onChange={handleInputChange}
                    className="w-full p-2 border rounded focus:ring focus:ring-indigo-200"
                  />
                ) : (
                  <p className="text-gray-800">{facultyData.teachingHours}</p>
                )}
              </div>
            </div>
            {isEditing && (
